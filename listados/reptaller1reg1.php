...
require_once('class.ezpdf.php');
 include("conexion.php");
	...
	$sql="select numcuentaalum as numcuenta,nombrealum as nombre,semestre as sem,grupo as grp,carreraalum as carrera,asistencia as asistencia FROM taller1reg1";
...
$i=0;
	...
	$titles=array('num'=>'num','numcuenta'=>'<b>NoCuenta</b>', 'nombre'=>'<b>Nombre</b>','sem'=>'<b>Sem</b>','grp'=>'<b>grp</b>','carrera'=>'carrera','asistencia'=>'asistencia');
...
$txttit.= "III COLOQUIO DE FORMACION DOCENTE E INNOVACION EDUCATIVA\n";
$txttit.= "Taller La importancia de convertirse en persona \n";
$txttit.= "Instructor: Mtra. Rosario De Lourdes Salazar Silva\n";
$txttit.= "Jueves 5 y Viernes 6 de Octubre de 2017\n";
