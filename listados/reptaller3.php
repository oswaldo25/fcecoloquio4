...
require_once('class.ezpdf.php');
 include("conexion.php");
	...
	$sql="select numcuentaalum as numcuenta,nombrealum as nombre,semestre as sem,grupo as grp,carreraalum as carrera,asistencia as asistencia FROM taller3";
...
$txttit.= "Taller Construccion de ciudadania y derechos humanos. \n";
$txttit.= "Instructor: Dra. Urenda Queletzy Navarro Sanchez. Universidad Autonoma de San Luis Potosi. \n";
$txttit.= "Jueves 26 y Viernes 27 de Abril de 2018\n";
