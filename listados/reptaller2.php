...
require_once('class.ezpdf.php');
 include("conexion.php");
	...
	$sql="select numcuentaalum as numcuenta,nombrealum as nombre,semestre as sem,grupo as grp,carreraalum as carrera,asistencia as asistencia FROM taller2";
...
$txttit.= "Taller Elaboracion de proyectos de investigacion en contextos de ciudadania \n";
$txttit.= "Instructor: Dr. Omar Ivan Gavotto Nogales. Universidad de Sonora \n";
