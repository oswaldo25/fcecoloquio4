...
require_once('class.ezpdf.php');
 include("conexion.php");
	...
	$sql="select cuentaalum as numcuenta,nomalum as nombre,gradoalum as sem,grupoalum as grp,carreraalum as carrera FROM alumnosfce2018 where carreraalum = 'LICENCIADO EN EDUCACION ESPECIAL' and grupoalum = 'E' ";
...
$txttit.= "Lista de Alumnos de 8o Semestre Grupo E\n";
