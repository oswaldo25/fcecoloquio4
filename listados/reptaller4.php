...
require_once('class.ezpdf.php');
 include("conexion.php");
	...
	$sql="select numcuentaalum as numcuenta,nombrealum as nombre,semestre as sem,grupo as grp,carreraalum as carrera,asistencia as asistencia FROM taller4";
...
$txttit.= "Taller Estrategias para combatir la discriminacion en las aulas. \n";
$txttit.= "Instructor: Dra. Myriam Rebeca Perez Daniel. Universidad de Colima. \n";
